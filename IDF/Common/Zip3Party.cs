...
namespace Runing.Increment
{
    ...
    public class Zip3Party
    {
        ...
        public static bool CreatZipFile(string targetFileName, params string[] sourceFileNames)
        {
            bool result = true;
        ...
        /// <returns>压缩包压缩是否成功</returns>
        public static bool CreatZipFile(string targetFileName, string sourceDirectory)
        {
            bool result = true;
        ...
        /// <summary>
        /// 解压Zip文件中的第一个文件 by dx
        /// </summary>
        /// <param name="stream"></param>
        /// <returns></returns>
        public static byte[] ExtractSingleFile(Stream stream)
        {
            MemoryStream msFile = new MemoryStream();
            stream.Position = 0;//流要降到起始，否则会读不到数据
